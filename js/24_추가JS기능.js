...
btn1.addEventListener("click", () => {
    ...
    for(let key in obj){
        ...
        if(key === "option"){
            for(let key2 in obj[key]){
                ...
                // obj[key][key2] === obj["option"]["rspicy0"]
    ...
    // menu가 문자열이 아닌 변수명으로 인식되어 오류 발생
    // -> 해결 방법 : 문자여로 인식할 수 있게 "", '' 감싸기
...
btn3.addEventListener("click", ()=>{
    ...
    // * 얕은 복사(Shallow copy) : 같은 주소를 복사하여 저장한 여러 변수가 하나의 객체를 참조하는 것

    //-------------------------------------------------------------------

    // * 깊은 복사(Deep copy) : 객체의 모양과 저장된 값을 그대로 복사 == 복제
