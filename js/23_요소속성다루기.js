...
btn2.addEventListener("click", ()=>{
    ...
    // [tip]
    // - 브라우저 콘솔에서 특정 요소가 가지고 있는 DOM 속성을 직접 확인하고 싶을 경우 
    //   -> 복수 형태로 요소를 얻어오는 querySelectAll(), getElementsByClassName() 등을 이ㅇㅅㅇ
...
- 요소.style.css 속성 방법은 inline-style로 적용되기 때문에
  HTML의 복잡도가 늘어나는 문제 발생

  단, calss를 이용한 css를 덮어 씌울 목적인 경우 사용
  왜? css 선택자 우선순위 참고
  (중요도가 높은 순)
  1. !important
  2. inline-style
