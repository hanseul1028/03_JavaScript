/* 전멱 변수 (js 전체에서 공용으로 사용할 수 있는 변수) */
...
amount.value = ""; // input 에 작성된 값을 삭제하는 효과
// -> 입, 출금 함수 마지막에 사용하세요
...
function withdrawal(){
    ...
    // alert(`000원이 출금 되었습니다. 남은 잔액 : 000원`);
